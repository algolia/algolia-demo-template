...
function extractSpecifications(
  ...
  if ((product as any).età?.value) {
    specs.push({ label: "Età", value: (product as any).età.value });
  }
  if ((product as any).taglia?.value) {
    specs.push({ label: "Taglia", value: (product as any).taglia.value });
  }
  if ((product as any).gusto?.value) {
    specs.push({ label: "Gusto", value: (product as any).gusto.value });
  }
